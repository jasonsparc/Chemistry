 ...
 */
public class UltimateClassMap<V> extends IdentityHashMap<Class<?>, V> {
	private static final Object DUMMY = new Object();

	@Nullable private IdentityHashMap<Class<?>, V> cache;

	public UltimateClassMap() { }

	public UltimateClassMap(int maxSize) {
		super(maxSize);
	}

	public UltimateClassMap(Map<? extends Class<?>, ? extends V> map) {
		super(map);
	}
	...
	public V putIfUnresolved(@Nullable Class<?> key, @Nullable V value) {
		final V dummy = UltimateClassMap.dummy();
	...
	/**
	 * Gets the mapping for the specified class, or finds the <b>nearest ultimate</b> class in its
	 * super hierarchy for any mappings, and returns the resolved mapping. If no mapping was found,
	 * returns {@code valueIfFailed}.
	 * <p>
	 * <b>Nearness</b> and <b>ultimate</b> here is defined as follows...
	 * <p>
	 ...
	 * right, then upwards.
	 * <p>
	 * The <b>nearness</b> class that has a mapping is the left most class with the lowest
	 * hierarchy level number relative to class {@code A}. This is how the <b>nearness</b> of a
	 * class is defined.
	 * <p>
	 * In the above diagram, we could see that interface {@code I} is implemented 4 times. When
	 * resolving a mapping, we skip all the other {@code I}'s found except for the left most {@code
	 * I} with the highest hierarchy level number. The {@code I} here that was not skipped is the
	 * <b>ultimate</b> class {@code I}, and is found at level {@code [3]} right above class {@code
	 * E}.
	 * <p>
