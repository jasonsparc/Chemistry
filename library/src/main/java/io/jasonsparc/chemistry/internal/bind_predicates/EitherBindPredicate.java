 ...
 */
public final class EitherBindPredicate<VH extends ViewHolder> implements BindPredicate<VH> {
	@NonNull final BindPredicate<? extends VH> first;
	@NonNull final BindPredicate<? extends VH> second;

	public EitherBindPredicate(@NonNull BindPredicate<? extends VH> first, @NonNull BindPredicate<? extends VH> second) {
		this.first = first;
		this.second = second;
	}
